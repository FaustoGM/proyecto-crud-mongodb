...
API básica con CRUD de Usuarios, Categorías y Productos.
Los productos tienen una categoría (se usa populate).
Las rutas de crear/editar/borrar usan JWT.
...
PORT=3000
MONGODB_URI=mongodb://localhost:27017/tp_crud
JWT_SECRET=un-secreto-largo-y-dificil
JWT_EXPIRES=1h
...
Mongo en Docker:
docker run -d --name tp_mongo -p 27017:27017 -v mongo_data:/data/db mongo:7
...

{
  ...
  "price": 800,
  "stock": 120,
  "category": "<ObjectId de una categoría existente>"
}
...

{
  ...
  "price": 800,
  "stock": 120,
  "category": "{{createCategory.response.body.data._id}}"
}
